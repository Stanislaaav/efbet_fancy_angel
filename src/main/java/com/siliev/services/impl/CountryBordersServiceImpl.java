...
public class CountryBordersServiceImpl implements CountryBordersService {
    ...
    public CountryBordersServiceImpl(CountryBordersRepository countryBordersRepository, ModelMapper modelMapper) {
    ...
    @Override
    public void populateCountryBorders() {
        countryBordersRepository.populateCountryBorders();
    }
